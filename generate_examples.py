...
#phase 1.2: cars at an intersection
    ...
    #red fading
    PBL.add_effect(SlowColorTransition(start_rgb=(0, 0, 0), end_rgb=(125, 10, 4), start_time=P5_START_TIME, end_time=P5_START_TIME+5, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SolidColor(rgb=(125, 10, 4), start_time=P5_START_TIME+5, end_time=P5_START_TIME+10, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(0, 0, 0), end_rgb=(125, 10, 4), start_time=P5_START_TIME+5, end_time=P5_START_TIME+10, y1=BRIDGE_HEIGHT//2))
    # orange fading
    PBL.add_effect(SolidColor(rgb=(125, 10, 4), start_time=P5_START_TIME+10, end_time=P5_START_TIME+15, y1=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(125, 10, 4), end_rgb=(209, 84, 21), start_time=P5_START_TIME+10, end_time=P5_START_TIME+15, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SolidColor(rgb=(209, 84, 21), start_time=P5_START_TIME+15, end_time=P5_START_TIME+20, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(125, 10, 4), end_rgb=(209, 84, 21), start_time=P5_START_TIME+15, end_time=P5_START_TIME+20, y1=BRIDGE_HEIGHT//2))
    # yellow fading
    PBL.add_effect(SolidColor(rgb=(209, 84, 21), start_time=P5_START_TIME+20, end_time=P5_START_TIME+25, y1=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(209, 84, 21), end_rgb=(235, 227, 19), start_time=P5_START_TIME+20, end_time=P5_START_TIME+25, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SolidColor(rgb=(235, 227, 19), start_time=P5_START_TIME+25, end_time=P5_START_TIME+30, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(209, 84, 21), end_rgb=(235, 227, 19), start_time=P5_START_TIME+25, end_time=P5_START_TIME+30, y1=BRIDGE_HEIGHT//2))
    # green fading
    PBL.add_effect(SolidColor(rgb=(235, 227, 19), start_time=P5_START_TIME+30, end_time=P5_START_TIME+35, y1=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(235, 227, 19), end_rgb=(77, 235, 19), start_time=P5_START_TIME+30, end_time=P5_START_TIME+35, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SolidColor(rgb=(77, 235, 19), start_time=P5_START_TIME+35, end_time=P5_START_TIME+40, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(235, 227, 19), end_rgb=(77, 235, 19), start_time=P5_START_TIME+35, end_time=P5_START_TIME+40, y1=BRIDGE_HEIGHT//2))
    # blue fading
    PBL.add_effect(SolidColor(rgb=(77, 235, 19), start_time=P5_START_TIME+40, end_time=P5_START_TIME+45, y1=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(77, 235, 19), end_rgb=(19, 102, 235), start_time=P5_START_TIME+40, end_time=P5_START_TIME+45, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SolidColor(rgb=(19, 102, 235), start_time=P5_START_TIME+45, end_time=P5_START_TIME+50, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(77, 235, 19), end_rgb=(19, 102, 235), start_time=P5_START_TIME+45, end_time=P5_START_TIME+50, y1=BRIDGE_HEIGHT//2))
    # indigo fading
    PBL.add_effect(SolidColor(rgb=(19, 102, 235), start_time=P5_START_TIME+50, end_time=P5_START_TIME+55, y1=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(19, 102, 235), end_rgb=(64, 22, 217), start_time=P5_START_TIME+50, end_time=P5_START_TIME+55, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SolidColor(rgb=(64, 22, 217), start_time=P5_START_TIME+55, end_time=P5_START_TIME+60, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(19, 102, 235), end_rgb=(64, 22, 217), start_time=P5_START_TIME+55, end_time=P5_START_TIME+60, y1=BRIDGE_HEIGHT//2))
    # purple fading
    PBL.add_effect(SolidColor(rgb=(64, 22, 217), start_time=P5_START_TIME+60, end_time=P5_START_TIME+65, y1=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(64, 22, 217), end_rgb=(131, 19, 212), start_time=P5_START_TIME+60, end_time=P5_START_TIME+65, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SolidColor(rgb=(131, 19, 212), start_time=P5_START_TIME+65, end_time=P5_START_TIME+70, y2=BRIDGE_HEIGHT//2))
    PBL.add_effect(SlowColorTransition(start_rgb=(64, 22, 217), end_rgb=(131, 19, 212), start_time=P5_START_TIME+65, end_time=P5_START_TIME+60, y1=BRIDGE_HEIGHT//2))
